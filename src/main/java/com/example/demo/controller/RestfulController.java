...
public class RestfulController {
	...
	public ResponseEntity<MovieTicket>getMovieByName (@PathVariable String movieName){
		MovieTicket mt= movieTicketRepository.findyByMoviename(movieName);
		if(mt!=null) {
	...
	public ResponseEntity<MovieTicket>getMovieById (@PathVariable int id){
		MovieTicket mt= movieTicketRepository.findyByMovieID(id);
		if(mt!=null) {
			return new ResponseEntity<MovieTicket>(mt, HttpStatus.OK);
			}
		else {
	...
	public ResponseEntity<Admin>checkAdmin (@PathVariable String username){
		Admin ad= adminRepository.findByName(username);
		if(ad!=null)
